...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.ted.service.impl.PasswordTokenManager#generateRecoveryToken(com.ted.model.User)
     */
    @Override
    ...
    /**
     * @see com.ted.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.ted.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.ted.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
